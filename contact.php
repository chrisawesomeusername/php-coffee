...
This way, the user will get error messages on the same page as the form. -->
	<form action="contact.php" method="post" class="px-0 my-5">
		...
		<input class="mx-3" type="text" id="name" name="name"> <br> <br>

		<label for = "email"> Email </label>
		<input class="mx-4" type="text" id="email" name="email"><br> <br>


		<label for = "subject"> Subject </label>
		<input class="mx-2" type="text" id="subject" name="subject" size="35"><br> <br>
